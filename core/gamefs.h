...
// CRC32
#ifdef _CRC_CHECK_
static const unsigned long int crc32table[256] = { // crc32 table generated using standart polynom
...
static const unsigned long int mask = 0xFFFFFFFFUL;		// XOR mask for CRC32
#endif // _CRC_CHECK_
