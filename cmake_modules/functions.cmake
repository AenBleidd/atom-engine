...
function (CreateMessagesFile filename ModuleName VarName)
  ...
  foreach(line ${file_text})
    if (${line} MATCHES "^<(.+)> (.+)$")
      string(COMPARE EQUAL ${CMAKE_MATCH_1} "" res1)
      string(COMPARE EQUAL ${CMAKE_MATCH_2} "" res2)
      if (${res1} EQUAL 1 OR ${res2} EQUAL 1)
        message(FATAL_ERROR "Incorrect file")
      endif (${res1} EQUAL 1 OR ${res2} EQUAL 1)
      list(APPEND list_id ${CMAKE_MATCH_1})
      list(APPEND list_text ${CMAKE_MATCH_2})
    else ()
    message(FATAL_ERROR "Incorrect file")
    endif (${line} MATCHES "^<(.+)> (.+)$")
  endforeach(line)
